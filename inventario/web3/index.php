...
<head>
	...
	<title>Dashboard-Proveedor 3</title>
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
	<link rel="stylesheet" type="text/css" href="../web3/css/style.css">
</head>
<body><br>
<center><h1> Escritorio Del Proveedor 3</h1></center><br><br>
	<div class="container">
		<div class="row">
		<div class="col-md-4">
    ...
    <p class="card-text">Total de stock de todos los productos</p>
  </div>
		</div>
	</div>
		<div class="col-md-4">
			<div class="bg-warning text-white text-center m-1">
  			<div class="card-header">Total de productos registrados</div>
  			<div class="card-body">
    ...
    <p class="card-text">Costo total gastado en productos ($ en pesos mexicanos)</p>
  </div>
		</div>
		</div>
</div>
...
<div class="container">
		...
		<div class="row-my-3">
			<div class="col-md-12 text-center">
  			<h2>Reporte de gastos y stock</h2>
...
<script type="text/javascript" src="../web3/js/jquery.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>
<script type="text/javascript" src="../web3/js/index.js"></script>
