              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border" id="nuevo">
                          <h1 class="box-title"> Consultorios</h1>
                        <div class="box-tools pull-right">
                        </div>
                    </div>

                    <div class="box-header with-border" id="mlista">
                          <h1 class="box-title">Nuevo Consultorio <button id="btnagregar" class="btn btn-success" onclick="mostrarform(true)" title="Nuevo Consultorio"><i class="fa fa-plus-circle" ></i> </button></h1>
                        <div class="box-tools pull-right">
                        </div>
                    </div>
                    <!-- /.box-header -->
...
<script type="text/javascript" src="scripts/consultorio.js"></script>
<?php
}
ob_end_flush();
?>
